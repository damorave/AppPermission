...
export function CreatePermissionTypeComponent() {
    ...
    const save = async () => {
        const response = await fetch(`${appsettings.apiUrl}permissionTypes/create`, {
            method: 'POST',
            headers: {
        ...
        if (response.ok) {
            ...
            Swal.fire({
                title: "Error!",
                text: "No se pudo guardar el tipo de permiso",
                icon: "warning"
            });
        }
    }
